...
@section('content')
    <div class="row mb-3">
        <div class="col-3">
            ...
            <a href="{{ route('admin.disciplinas.create') }}" class="btn btn-success" role="button" aria-pressed="true">Nova
                Disciplina</a>
            @endcan
        </div>
        <div class="col-9">
                ...
                <tr>
                    ...
                    <td nowrap>
                        ...
                        <a href="{{ route('admin.disciplinas.edit', ['disciplina' => $disc]) }}"
                            ...
                            <i class="fas @cannot('update',$disc) fa-eye @else fa-pen @endcan"></i>
                        </a>
                        @else
                        <span class="btn btn-secondary btn-sm disabled"><i
                            class="fa @cannot('update',$disc) fa-eye @else fa-pen @endcan"></i></span>
                        @endcan
                        @can('delete',$disc)
                        <form action="{{route('admin.disciplinas.destroy',['disciplina' => $disc])}}" method="POST" class="d-inline"
